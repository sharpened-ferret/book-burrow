        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="mt-2 flex flex-row">
                        ...
                        <div class="flex flex-row basis-1/12">
                            <svg class="flex h-8 w-10" fill="none" stroke="currentColor" stroke-width="1.5" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            ...
            <div class="bg-white dark:bg-gray-700 overflow-hidden shadow-sm sm:rounded-lg text-sm mt-4">
                ...
                <div class="flex flex-row justify-start" >
                    <div class="basis-11/12">
                        <p class="mt-2"><a class="no-underline hover:underline" href="{{route('users.show', ['id' => $comment->user->id])}}">{{$comment->user->name}}</a>
